...
Breakout = {
  ...
  Defaults: {
    ...
    ball: {
      radius:  <?php if(isset($_GET['ballRadius'])){ echo $_GET['ballRadius']; } else { echo $ballRadius; }?>,
      speed:   <?php if(isset($_GET['ballSpeed'])){ echo $_GET['ballSpeed']; } else { echo $ballSpeed; }?>,
      labels: {
    ...
    paddle: {
      width:  <?php if(isset($_GET['paddleWidth'])){ echo $_GET['paddleWidth']; } else { echo $paddleWidth; }?>,
      height: 1,
      speed:  20
    },
    ...
    update: function(dt) {
      ...
      window.scores = this.score.score;
    },
    ...
    Score: {
      ...
      load:     function()  { this.highscore = this.game.storage.highscore ? parseInt(this.game.storage.highscore) : 0; window.highScores = this.highscore; },
      save:     function()  { if (this.score > this.highscore) this.game.storage.highscore = this.highscore = this.score; window.highScores = this.highscore; },
